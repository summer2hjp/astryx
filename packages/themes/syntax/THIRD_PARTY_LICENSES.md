...
This package contains syntax color palettes derived from the following
open-source themes. All original themes are licensed under the MIT License.
Only color values have been extracted — no source code from these projects
is included.
